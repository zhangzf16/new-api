...
const defaultSiteSettings: SiteSettings = {
  'theme.mode': DEFAULT_ADMIN_VISUAL_THEME.mode,
  'theme.preset': DEFAULT_ADMIN_VISUAL_THEME.preset,
  'theme.font': DEFAULT_ADMIN_VISUAL_THEME.font,
  'theme.radius': DEFAULT_ADMIN_VISUAL_THEME.radius,
  'theme.scale': DEFAULT_ADMIN_VISUAL_THEME.scale,
  Notice: '',
  SystemName: 'New API',
  Logo: '',
  Footer: '',
